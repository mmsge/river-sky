...
- Service documentation lives at `hetzner-server/services/daggerheart.md`
...
**Port 4000 is reserved for this service.** Do not change it without updating the Caddyfile in `hetzner-server`.
